...
<tutorials/physics/physics_introduction:collision layers and masks>`.

Controlling physics interactions
--------------------------------

Physics bodies have access to two complementary properties: layers and masks.
Layers define on which physics layers an object is.
...
collisions with the floor. To do so, we can use Rebel Engine's :doc:`group
</tutorials/scripting/groups>` tagging feature.

...
.. Generated automatically by RebelEngine/tools/scripts/rst_from_xml.py.. DO NOT EDIT THIS FILE, but the @GDScript.xml source instead.
...
**Note:** ``dectime`` has been deprecated, please use :ref:`move_toward<class_@GDScript_method_move_toward>` instead.
...
.. figure:: /img/ease_cheatsheet.png
...
**Note:** Due to limitations with Rebel Engine's built-in console, this only prints to the terminal. If you need to print in the editor, use another method, such as :ref:`print<class_@GDScript_method_print>`.
...
Pushes an error message to Rebel Engine's built-in debugger and to the OS terminal.
...
Pushes a warning message to Rebel Engine's built-in debugger and to the OS terminal.
...
.. figure:: /img/smoothstep_ease_comparison.png

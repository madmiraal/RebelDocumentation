...
.. Generated automatically by RebelEngine/tools/scripts/rst_from_xml.py.. DO NOT EDIT THIS FILE, but the EditorPlugin.xml source instead.
...
Returns the :ref:`EditorInterface<class_EditorInterface>` object that gives you control over Rebel Engine editor's window and its functionalities.
...
Override this method in your plugin to provide the name of the plugin when displayed in the Rebel Engine editor.

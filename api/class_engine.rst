...
.. Generated automatically by RebelEngine/tools/scripts/rst_from_xml.py.. DO NOT EDIT THIS FILE, but the Engine.xml source instead.
...
See `Running code in the editor <https://docs.rebeltoolbox.com/en/latest/tutorials/misc/running_code_in_the_editor.html>`__ in the documentation for more information.
...
Returns Dictionary of licenses used by Rebel Engine and included third party components.
...
Returns Rebel Engine license text.
...
Returns a global singleton with given ``name``. Often used for plugins on Android.

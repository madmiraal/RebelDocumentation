...
La diferencia de dirección en radianes entre puntos de vectores. Este valor sólo se utiliza si ``joint mode`` se establece en :ref:`LINE_JOINT_SHARP<class_Line2D_constant_LINE_JOINT_SHARP>`.

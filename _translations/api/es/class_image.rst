...
Llena la imagen con un determinado :ref:`Color<class_Color>`.
...
Loads an image from file ``path``. See :ref:`Supported image formats <tutorials/assets_pipeline/importing_images:supported image formats>` for a list of supported image formats and limitations.

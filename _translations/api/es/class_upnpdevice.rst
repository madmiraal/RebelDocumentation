...
- **IGD_STATUS_DISCONNECTED** = **6** --- Desconectado.

- **IGD_STATUS_UNKNOWN_DEVICE** = **7** --- Dispositivo desconocido.

- **IGD_STATUS_INVALID_CONTROL** = **8** --- Control inválido.

- **IGD_STATUS_MALLOC_ERROR** = **9** --- Error de asignación de memoria.

- **IGD_STATUS_UNKNOWN_ERROR** = **10** --- Error desconocido.

...
- **IGD_STATUS_DISCONNECTED** = **6** --- 已断开连接。

- **IGD_STATUS_UNKNOWN_DEVICE** = **7** --- 未知设备。

- **IGD_STATUS_INVALID_CONTROL** = **8** --- 无效控件。

- **IGD_STATUS_MALLOC_ERROR** = **9** --- 内存分配错误。

- **IGD_STATUS_UNKNOWN_ERROR** = **10** --- 未知错误。

...
Singleton that connects the engine with the browser's JavaScript context in Web exports.
...
- :ref:`tutorials/export/exporting_for_web:calling javascript from script`

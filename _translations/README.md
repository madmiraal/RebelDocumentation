...
Once the build is complete the make file will restore the original Rebel Documentation root `api/` directory.
...
When both a language's [Rebel Engine API](#rebel-engine-api-translations) and [Rebel Documentation](#rebel-documentation-translations) translations reach a level of completion (currently 66%), and

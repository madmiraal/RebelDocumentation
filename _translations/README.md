...
The translatiosns there are stored in the `translations/` folder.
...
Inside each `locales/<LANGUAGE_CODE>/LC_MESSAGES` folder are the languge's `.po` ([Portable Object](https://www.gnu.org/software/gettext/manual/html_node/PO-Files.html)) files.
